...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used by the construction of the info
    | page.
    |
    */

    'slogan' => 'Een gedigitaliseerd gezelschapspel gebasseerd op de betoverde doolhof in thema Alice in Wonderland. ',
    'players-amount' => 'Het spel kan worden gespeeld met minstens 2 spelers en maximaal met 4. ',

    'creator-inspiration' => 'Gezelschapspelen vind ik ideaal om met mensen een band op te bouwen. 
    Ik wou een gezelschapspel maken dat mee gaat met zijn tijd en dus digitaal, maar ook niet afdoet aan de gezelligheid van een gezelschapspel. 
    Door het minimum vereiste van 2 spelers geeft dan ook een perfecte duw in de rug om gezelschap te zoeken. 
    Het thema Alice in Wonderland geeft enorm veel ruimte om gekke en leuke voorwerpen te zoeken en door het ook aanwezige doolhof een perfecte keuze. ',
    ...
    De vrijgekomen losse tegel is voor de volgende speler. ',
